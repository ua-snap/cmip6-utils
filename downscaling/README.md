...
* `rename_12km_variables.py` - This script is used to prepare daily 12km ERA5 outputs by changing the file variable names, file names, and directory names to match the 4km dataset. 
