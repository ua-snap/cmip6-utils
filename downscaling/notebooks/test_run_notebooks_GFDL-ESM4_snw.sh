...
# bash test_run_notebooks_GFDL-ESM4_snw.sh

# GFDL-ESM4	historical, ssp126, ssp245, ssp370, ssp585
papermill downscaled_snw.ipynb downscaled_snw_GFDL-ESM4.ipynb -p models 'GFDL-ESM4' -p scenarios 'historical ssp126 ssp245 ssp370 ssp585' -p threshold 2540
