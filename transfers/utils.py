...
def arguments(argv):
    ...
    parser = argparse.ArgumentParser(
        description="""To use this script, you must have the Globus Command Line Interface
    ...
    parser.add_argument(
        "-u", "--username", type=str, help="your Globus username", required=True
    )
    parser.add_argument(
        "-p",
        "--path",
        type=str,
        help="the path on your endpoint where you want files to be downloaded to",
        default="/~/",
    )
    parser.add_argument(
        "-l",
        "--list-endpoints",
        help="List the endpoints to be activated and exit (no transfer attempted)",
        action="store_true",
    )
