...
netcdf_to_zarr_sbatch_tmp_fn = "netcdf_to_zarr_{model}_{scenario}_{var_id}.sbatch"

cmip6_zarr_tmp_fn = "{var_id}_{model}_{scenario}.zarr"
ref_zarr_tmp_fn = "{var_id}_era5.zarr"

train_qm_sbatch_tmp_fn = "train_qm_{model}_{var_id}.sbatch"
bias_adjust_sbatch_tmp_fn = "bias_adjust_{model}_{scenario}_{var_id}.sbatch"
